        ...
        <GridContainer style={{paddingBottom: 100}} justify = "left">
            ...
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "left">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date1} size={size} /></span></GridItem>
                </GridContainer>
            </GridItem>
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "center">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date2} size={size} /></span></GridItem>
                </GridContainer>
            </GridItem>
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "center">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date3} size={size}/></span></GridItem>
                </GridContainer>
            </GridItem>
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "center">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date4} size={size}/></span></GridItem>
                </GridContainer>
            </GridItem>
            ...
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "left">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date5} size={size} /></span></GridItem>
                </GridContainer>
            </GridItem>
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "center">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date6} size={size} /></span></GridItem>
                </GridContainer>
            </GridItem>
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "center">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date7} size={size}/></span></GridItem>
                </GridContainer>
            </GridItem>
            <GridItem  xs={3} sm={3} md={3}>
                <GridContainer justify = "center">
                    ...
                    <GridItem xs={4} sm={4} md={4}><span><Clock value={date8} size={size}/></span></GridItem>
                </GridContainer>
            </GridItem>
        </GridContainer>
    );
